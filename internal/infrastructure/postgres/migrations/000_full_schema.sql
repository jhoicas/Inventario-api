...
CREATE INDEX IF NOT EXISTS idx_product_reorder_config_product_id ON product_reorder_config (product_id);
CREATE INDEX IF NOT EXISTS idx_product_reorder_config_warehouse_id ON product_reorder_config (warehouse_id);
