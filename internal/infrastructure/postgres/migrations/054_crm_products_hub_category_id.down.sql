-- Revertir vista/función a definición basada en ph.category (requiere columna category en crm_products_hub).
...
DROP INDEX IF EXISTS idx_crm_products_hub_category_id;

ALTER TABLE crm_products_hub DROP COLUMN IF EXISTS category_id;
